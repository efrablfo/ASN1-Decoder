...
public class PriceFactor implements Serializable {
	...
	private Percent priceFactor = null;
	private ServiceUnits units = null;
	
	public PriceFactor() {
	}

	public PriceFactor(byte[] code) {
		this.code = code;
	}

	public void setPriceFactor(Percent priceFactor) {
		this.priceFactor = priceFactor;
	}

	public Percent getPriceFactor() {
		return priceFactor;
	}
	...
	public int encode(OutputStream os, boolean withTag) throws IOException {
		...
		if (priceFactor != null) {
			codeLength += priceFactor.encode(os, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
			priceFactor = new Percent();
			subCodeLength += priceFactor.decode(is, false);
