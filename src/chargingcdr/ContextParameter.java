...
public class ContextParameter implements Serializable {
	...
	public ContextParameter(byte[] code) {
		this.code = code;
	}

	public void setParameterID(Integer64 parameterID) {
		this.parameterID = parameterID;
	}

	public Integer64 getParameterID() {
		return parameterID;
	}

	public void setParameterValue(ContextParameterValueType parameterValue) {
		this.parameterValue = parameterValue;
	}

	public ContextParameterValueType getParameterValue() {
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
			...
			parameterValue = new ContextParameterValueType();
