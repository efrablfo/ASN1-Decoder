...
public class AccumulatorSpecifiedConsumption implements Serializable {
	...
	public AccumulatorSpecifiedConsumption() {
	}

	public AccumulatorSpecifiedConsumption(byte[] code) {
		this.code = code;
	}
